...
# from Home import participant_name
...
background_image = ''' <style>
        [data-testid="stAppViewContainer"]{
            background-image: url('https://pbs.twimg.com/media/GE_lXFmbkAAHVcV?format=png&name=small');
...
st.write("Genre Chosen: Indian History")

def main():
    quiz = HistoryQuiz()

    question = quiz.user_genre("India")
