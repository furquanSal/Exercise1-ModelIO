...
background_image = ''' <style>
        [data-testid="stAppViewContainer"]{
            background-image: url('https://pbs.twimg.com/media/GE_nf5xaYAEZJh1?format=png&name=360x360');
...
st.write("Genre Chosen : World War History")
...
def main():
    ...
    #     st.session_state.current_question = quiz.user_genre("World War")

    # question = st.session_state.current_question
    
    question = quiz.user_genre("World War")
