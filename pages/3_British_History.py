...
background_image = ''' <style>
        [data-testid="stAppViewContainer"]{
            background-image: url('https://pbs.twimg.com/media/GE_nf5ybIAA1f-h?format=png&name=small');
...
st.write("Genre Chosen : British History")
...
def main():
    ...
    question = quiz.user_genre("British")
